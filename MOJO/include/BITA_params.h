...
such captures at different times. These parameters are utilized to continuously
maintain the target's state. Also, right after their capture, 'PredictionSupplier's
routine 'updateBITA_ParamsInSupplierInput' edits a simulation input file to take the
